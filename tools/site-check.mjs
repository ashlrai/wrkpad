...
for(const phrase of ['Connected is the start','Choose white wired mode','Select layer 1','within 350 ms','Recover without wiping','Reset settings'])if(!html.toLowerCase().includes(phrase.toLowerCase()))failures.push(`missing first-run phrase ${phrase}`)
