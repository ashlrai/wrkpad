...
describe('operator interface', () => {
  ...
  it('keeps Codex Native observer-only and out of the Ashlr Flight Check', async () => {
    ...
    expect(nativeTruth.textContent).toContain('Cached Ashlr Daily is not device proof')
    expect(nativeTruth.textContent).toContain('white WIRED mode')
    expect(nativeTruth.textContent).toContain('layer LEDs indicate Layer 1')
