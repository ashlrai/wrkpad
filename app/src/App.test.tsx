...
describe('operator interface', () => {
  ...
  it('keeps Codex Native observer-only and out of the Ashlr Flight Check', async () => {
    ...
    expect(nativeTruth.textContent).toContain('Cached Ashlr Daily targets shortcuts')
    expect(nativeTruth.textContent).toContain('manually Import layer')
    expect(nativeTruth.textContent).toContain('Codex Native Recovery first (badge 1)')
    expect(nativeTruth.textContent).toContain('Ashlr Daily becomes badge 2')
    ...
    expect(routeWarning.textContent).toContain('numeric 1 or layer LED identifies only a layer index')
    expect(routeWarning.textContent).toContain('does not prove native KV_OAI_* bindings')
    expect(routeWarning.textContent).toContain('export a backup')
